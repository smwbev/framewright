...
<p align="center">
  <a href="https://github.com/smwbev/framewright/releases"><img src="https://img.shields.io/badge/version-1.3.0-08C?style=flat" alt="Версия 1.3.0" /></a>
...
визуальная контрольная точка и запрет на «и так понятно». Оба режима выше получаются одним и
тем же процессом: концепцию одним кадром агент строит как единый мир.
